    ...
    <div className="flex flex-col justify-center gap-5 p-10">
      ...
      <div className="flex flex-col lg:flex-row justify-around gap-10">
        ...
        <div className="flex justify-center items-center p-2">
          <img className="border-4 rounded-full border-(--quaternaria) hover:border-(--quinternaria)" src="https://media.licdn.com/dms/image/v2/D4D03AQEFCRWHfqh6Mg/profile-displayphoto-scale_200_200/B4DZgLef.gGkAY-/0/1752539202030?e=1770249600&v=beta&t=ACua9cQ7ImVtyiTTi12pON-cwrH-YXTTODRLd9z5nl0" alt="Imagem do linkedin" />
        </div>

    ...
    <div className="flex flex-col justify-center gap-5 p-10">
      ...
      <div className="flex flex-col lg:flex-row justify-around gap-10">
        ...
        <div className="flex justify-center items-center p-2">
          <img className="border-4 rounded-full border-(--quaternaria) hover:border-(--quinternaria)" src="https://media.licdn.com/dms/image/v2/D4D03AQEFCRWHfqh6Mg/profile-displayphoto-scale_400_400/B4DZgLef.gGkAg-/0/1752539202030?e=1778716800&v=beta&t=E2YypslzGHCoKPvLoRZ7Dr_ZlM9t2Bw_TEA3vPUSuYc" alt="Imagem do linkedin" />
        </div>
